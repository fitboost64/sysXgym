...
async function generateSplashScreens() {
  console.log('🎨 Generating iOS splash screens with logo...\n');
    ...
    try {
      ...
      await sharp({
        ...
        .composite([
          ...
          {
            input: logoBuffer,
            top: Math.floor((height / 2) - (logoSize / 2) - (height * 0.05)),
  ...
  console.log(`📁 Saved to: ${splashDir}`);
  console.log('🎨 Using real logo with black background\n');
}
