        ...
        <div className="p-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="mt-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border-2 border-blue-400 rounded-lg text-sm font-bold"
                    placeholder="0.00"
                  />
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div className="bg-gradient-to-br from-blue-50 to-pink-50 border-2 border-blue-200 rounded-xl p-4">
                <h3 className="font-bold text-base mb-3 flex items-center gap-2">
                  <span>📅</span>
              ...
              <div className="space-y-4">
                <div className="bg-gradient-to-br from-blue-50 to-blue-50 border-2 border-blue-200 rounded-xl p-4">
