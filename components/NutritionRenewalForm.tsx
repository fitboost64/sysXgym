      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {packages.map(pkg => (
                  <button
                    ...
                    className="bg-white hover:bg-lime-50 border-2 border-lime-300 hover:border-lime-500 rounded-xl p-3 transition transform hover:scale-105 hover:shadow-lg"
                  >
          ...
          <div className="bg-green-50 border-l-4 border-r-4 border-green-500 p-3 rounded-lg mb-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div>
                <p className="text-xs text-gray-600">{t('nutrition.renewal.nutritionNumber')}</p>
                <p className="text-xl font-bold text-green-600">#{session.nutritionNumber}</p>
              </div>
              <div>
                <p className="text-xs text-gray-600">{t('nutrition.renewal.clientName')}</p>
                <p className="text-base font-bold">{session.clientName}</p>
              </div>
              <div>
                <p className="text-xs text-gray-600">{t('nutrition.renewal.currentNutritionist')}</p>
                <p className="text-base">{session.nutritionistName}</p>
              </div>
              <div>
                <p className="text-xs text-gray-600">{t('nutrition.renewal.currentSessionsRemaining')}</p>
            ...
            {session.expiryDate && (
              <div className="mt-2 pt-2 border-t border-green-200">
                <p className="text-xs text-gray-600 inline-block">{t('nutrition.renewal.currentExpiryDate')}: </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="bg-gradient-to-br from-green-50 to-indigo-50 border-2 border-green-200 rounded-xl p-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div className="bg-gradient-to-br from-green-50 to-pink-50 border-2 border-green-200 rounded-xl p-4">
                ...
                {duration !== null && formData.expiryDate && (
                  <div className="bg-white border-2 border-green-300 rounded-lg p-2">
                    {duration > 0 ? (
                ...
                <div className="bg-gradient-to-br from-yellow-50 to-orange-50 border-2 border-yellow-200 rounded-xl p-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-600">{t('nutrition.renewal.newSessionsLabel')}</span>
                    ...
                    <div className="bg-green-100 border-l-4 border-r-4 border-green-500 p-2 rounded">
                      <div className="flex justify-between">
                        <span className="font-bold text-gray-800 text-sm">{t('nutrition.renewal.paidAmount')}</span>
