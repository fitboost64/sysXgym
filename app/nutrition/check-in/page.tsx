...
export default function NutritionCheckInPage() {
  ...
  const handleCheckIn = async (e: React.FormEvent) => {
    ...
    if (!qrCode.trim() || qrCode.trim().length === 0) {
      toast.warning('يرجى إدخال رقم Nutrition أو Barcode')
      return
    }
    ...
    try {
      const response = await fetch('/api/nutrition/check-in', {
        method: 'POST',
        ...
        <div className="bg-white rounded-3xl shadow-2xl max-w-lg w-full p-8 text-center">
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-50 border-2 border-green-300 rounded-2xl p-6 mb-6 text-right">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center bg-green-100 -mx-6 px-6 py-3 mt-4">
                <span className="text-green-800 font-semibold">الجلسات المتبقية:</span>
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full bg-gradient-to-r from-green-600 to-green-600 text-white py-4 rounded-xl hover:from-green-700 hover:to-green-700 font-bold text-lg shadow-lg"
            >
              تسجيل جلسة أخرى
            </button>
            <button
        ...
        <form onSubmit={handleCheckIn} className="space-y-6">
          ...
          {qrCode && (
            <div className="bg-green-50 border-2 border-green-200 rounded-xl p-4">
              ...
              <p className="font-mono text-sm text-green-900 break-all select-all">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-green-600 to-green-600 text-white py-4 rounded-xl hover:from-green-700 hover:to-green-700 disabled:from-gray-400 disabled:to-gray-500 disabled:cursor-not-allowed font-bold text-lg shadow-lg transition"
          >
